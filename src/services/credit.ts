...
export enum CreditsTransType {
  ...
  AIDestinyReading = "ai_destiny_reading", // AI运势解读
  AIRecipeGeneration = "ai_recipe_generation", // AI智能食谱生成
}

export enum CreditsAmount {
  NewUserGet = 10,
  PingCost = 1,
  AIDestinyReadingCost = 5, // AI运势解读消耗5积分
  AIRecipeGenerationCost = 3, // AI食谱生成消耗3积分
}
