...
export async function updateOrderSession(
  ...
  const updateData: any = { order_detail };
  
  // Use stripe_session_id for all providers to maintain compatibility
  // In the future, we might want to rename this field to session_id
  updateData.stripe_session_id = session_id;
