                      ...
                      {item.cn_amount && item.cn_amount > 0 ? (
                        <div className="flex items-center gap-x-2 mt-2">
                          ...
                          >
                            <img
                              src="/imgs/cnpay.png"
                              alt="CNPay Chinese payment gateway logo for Mondkalender subscription billing and credit purchases"
                              title="CNPay Chinese payment gateway logo for Mondkalender subscription billing and credit purchases"
